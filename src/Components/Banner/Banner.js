...
library.add(faFacebook, faLinkedin, faGithub, faMedium);
    ...
    <div className="container">
      ...
      >
        <Fade up>
          <div className="py-4">
            <h1
              style={{ fontSize: '50px', fontWeight: '700', color: '#00adb5' }}
            >
              Juaid Rakin
            </h1>
            <h3 style={{ fontWeight: '700', color: '#00adb5' }}>
            ...
            <div className="d-flex flex-wrap justify-content-center">
              <button onClick={openModal} className="btn-brand m-3">
                Get In Touch
              </button>
              <Modal
                isOpen={modalIsOpen}

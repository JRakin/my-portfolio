      ...
      <div className="row">
        <div className="col-md-6 p-3">
          ...
          <p style={{ fontSize: '18px' }}>
            ...
            <span className="font-weight-bold">node.js</span>. Juaid initially
            loved <span className="font-weight-bold">java</span> but end up
            being a <span className="font-weight-bold">MERN</span> stack
            developer. Juaid loves to solve problems.
          </p>
        </div>
        <div className="col-md-6 p-3">
